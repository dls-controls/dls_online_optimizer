...
@algorithm_variation_designer: Gareth Bird

FOR COMMENTED VERSION WITH FULL DOCUMENTATION, SEE VERSION IN ./DLS-OnlineOptimiser/injection_control
'''
...
class optimiser:
    ...
    def __init__(self, settings_dict, interactor, store_location, a_min_var, a_max_var, individuals=None, progress_handler=None):
        ...
        self.result_count = len(interactor.measurement_vars_noinj                       
    ...
    def getObjectives(self):
        ...
        measure, beam_current_max_warning = self.interactor.get_ar()
...
class import_algo_frame(Tkinter.Frame):
    ...
    def get_dict(self):
        ...
        try:
            ...
            tkMessageBox.showerror('MOSA settings error', 'The number of anneals before plotting must be an integer.')
            good_data = False
