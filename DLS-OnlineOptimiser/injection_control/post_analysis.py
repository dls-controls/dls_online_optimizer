'''
ANALYSIS TOOL for use of past optimisations in DLS OnlineOptimiser package with INJECTION CONTROL
...
#The next four classes are needed in order to mimic main.py.
