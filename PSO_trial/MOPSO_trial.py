...
#         pass
    ...
    def optimise(self):
        ...
        global swarm_history
        global pareto_history
        ...
        swarm_history.append(self.get_pareto_objectives(pareto_front))
...
algorithm = MOPSO(100, kursawe, bounds,40, 0.5, 2.0, 1.5)
algorithm.optimise()

print 'pareto history', pareto_history
print 'swarm history', swarm_history
