'''
MULTI-OBJECTIVE PARTICLE SWARM OPTIMISER for use in the DLS OnlineOptimiser package with injection control. 
...
class optimiser:
    ...
    def evaluate_swarm(self, swarm):
        ...
        for i in range(len(swarm)):
            ...
            all_data, beam_current_max_warning = self.interactor.get_ar()         #perform measurement 
            ...
            #need beam to be dumped if current goes over limit of lifetime proxy
